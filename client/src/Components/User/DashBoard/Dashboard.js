      ...
      <Row className="mt-5">
        ...
        <section id="sec-about" class="sec-about pt-5 pb-5">
          <div class="container">
            <div class="row justify-content-center text-center">
              <div class="col-md-10 col-lg-8">
                <h1 class="h4">What we Aim?</h1>
                <p class="mt-4 mb-4">
                  Encouraging members to work on coding projects, either
                  individually or in teams,
                  <br /> to develop their skills and create something tangible.
                  <br />
                  Providing a space for individuals to learn and practice coding
                  skills.
                </p>
              </div>
            </div>
